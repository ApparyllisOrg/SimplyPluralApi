...
export const get = async (req: Request, res: Response) => {
	...
	} = { timings: { morningFronters: [], dayFronters: [], eveningFronters: [], nightFronters: [] }, values: { sums: [], averages: [], maxes: [], mins: [], nums: [] } };
	...
	for (let i = 0; i < allResults.length; ++i) {
		...
		const value: frontDurationType | undefined = frontDurationsData[frontEntry.member];
