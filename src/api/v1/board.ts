...
const s_validateBoardPatchSchema = {
	type: "object",
	properties: {
		read: { type: "boolean" },
	},
...
const v_validateBoardPatchSchema = ajv.compile(s_validateBoardPatchSchema)

export const validateBoardPatchSchema = (body: unknown): { success: boolean; msg: string } => {
	return validateSchema(v_validateBoardPatchSchema, body)
}
