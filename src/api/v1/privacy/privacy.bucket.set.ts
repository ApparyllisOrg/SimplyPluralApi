...
const setPrivacyBucketsRecursive = async (groupId: string, uid: string, buckets: ObjectId[]) => {
...
export const setPrivacyBuckets = async (req: Request, res: Response) => {
	assert(req.body.type === "members" || req.body.type === "groups" || req.body.type === "frontStatuses" || req.body.type === "customFields")
