...
export const update = async (req: Request, res: Response) => {
	...
	if (previousDocument) {
		const performUpdate = (previousDocument.latestVersion && previousDocument.latestVersion < req.body.latestVersion) || (!previousDocument.latestVersion && req.body.latestVersion >= 300) // version 300 detected an issue where sometimes latest version was never set
