...
const s_validateCancelSubscriptionSchema = {
	type: "object",
	properties: {
...
const v_validateCancelSubscriptionSchema = ajv.compile(s_validateCancelSubscriptionSchema)

export const validateCancelSubscriptionSchema = (body: unknown): { success: boolean; msg: string } => {
	const schema = {}

	return validateSchema(v_validateCancelSubscriptionSchema, body)
}
