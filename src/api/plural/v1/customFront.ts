...
export const getCustomFronts = async (req: Request, res: Response) => {
	...
	fetchCollection(req, res, "frontStatuses", SimplyPluralDb, {});
}

export const get = async (req: Request, res: Response) => {
	fetchSimpleDocument(req, res, "frontStatuses", SimplyPluralDb);
}

export const add = async (req: Request, res: Response) => {
	addSimpleDocument(req, res, "frontStatuses", SimplyPluralDb);
}

export const update = async (req: Request, res: Response) => {
	updateSimpleDocument(req, res, "frontStatuses", SimplyPluralDb)
...
export const del = async (req: Request, res: Response) => {
	...
	deleteSimpleDocument(req, res, "frontStatuses", SimplyPluralDb);
}
